function initDeuda() {
  ...
  editarBtn.onclick = () => {
    ...
    editarBtn.textContent = modoEditar ? "Confirmar✅" : "Editar✏️";
  };

  // --- NUEVO: SALIR DEL MODO EDICIÓN CON ESCAPE ---
  document.addEventListener("keydown", (e) => {
    if (e.key === "Escape" && modoEditar) {
      modoEditar = false;
...
document.addEventListener("DOMContentLoaded", initDeuda);